...
public class ProductRestController 
{
	...
	// Browse - http://localhost:8085/ims/api/products/4
	...
	// In Postman - DELETE - http://localhost:8085/ims/api/products/8
	...
	// In Postman - PUT - http://localhost:8085/ims/api/products/7
	// Body -> Raw -> Json -> Enter Json Object -> Send
